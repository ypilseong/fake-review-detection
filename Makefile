...
mkvirtualenv: ## create the project environment
	@python3 -m venv "$$WORKON_HOME/fake-review-detection"
	@. "$$WORKON_HOME/fake-review-detection/bin/activate"
	@pip install --upgrade pip setuptools wheel

mkvirtualenv-system: ## create the project environment with system site packages
	@python3 -m venv "$$WORKON_HOME/fake-review-detection" --system-site-packages
	@. "$$WORKON_HOME/fake-review-detection/bin/activate"
	@pip install --upgrade pip setuptools wheel
