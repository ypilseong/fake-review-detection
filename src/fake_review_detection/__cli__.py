"""Command line interface for fake_review_detection"""

# Importing the libraries

import click

from fake_review_detection._version import __version__
...
def main(count, name):
    ...
    for _ in range(count):
        ...
        click.echo(f"This is fake_review_detection version {__version__}.")
